<?php
    ...
    class evenement {
        ...
        function gethtml() {
            ...
            $affichage = "<div class='slot $this->type z-depth-1' style=' grid-column: $column; grid-row: $row; '>";
            $affichage .= "<span>";
            $affichage .= date('H:i',$this->dateDebut) . " - " . date('H:i',$this->dateFin) ."</br>". $this->type;
            $affichage .= "</span>";
            $affichage .="</div>";
    ...
    $eventJSON = json_encode([$reservation_1 , $reservation_2, $reservation_3, $reservation_4]);
